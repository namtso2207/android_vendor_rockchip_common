...
public class MCURedOFFSeekBarPreference extends DialogPreference implements OnSeekBarChangeListener{
    ...
    public MCURedOFFSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
