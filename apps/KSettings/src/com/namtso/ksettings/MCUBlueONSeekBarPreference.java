...
public class MCUBlueONSeekBarPreference extends DialogPreference implements OnSeekBarChangeListener{
    ...
    public MCUBlueONSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
