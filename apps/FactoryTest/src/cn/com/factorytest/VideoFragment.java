                    ...
                    if (1 == MainActivity.ageing_flag) {
						if(2 == ageing_test_step && 2 != led_status){
							...
							if(1 == led_status){
								...
								Tools.writeFile(Tools.Ext_Led,"off");//default-on off heartbeat
								Tools.writeFile(Tools.Ext_Mcu_Led,"0x2a0");
								led_status = 0;
							}
							else if(0 == led_status){
								Tools.writeFile(Tools.White_Led,"default-on");//default-on off heartbeat
								Tools.writeFile(Tools.Ext_Led,"default-on");//default-on off heartbeat
								Tools.writeFile(Tools.Ext_Mcu_Led,"0x2a1");
								led_status = 1;
							}
						}
					}
