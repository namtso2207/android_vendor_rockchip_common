...
public class Alarms {
    ...
    private static void enableAlert(Context context, final Alarm alarm, final long atTimeInMillis) {
        ...
        Intent intent = new Intent(context, com.namtso.schpwronoff.SchPwrOffReceiver.class);
    ...
    private static void enableAlertPowerOn(Context context, final Alarm alarm, final long atTimeInMillis, boolean shutdown) {
        ...
        // Intent intent = new Intent(ALARM_ALERT_ACTION);
        // Intent intent = new Intent(context, SchedulePowerOff.class);
        Intent intent = new Intent(context, com.namtso.schpwronoff.SchPwrOnReceiver.class);
